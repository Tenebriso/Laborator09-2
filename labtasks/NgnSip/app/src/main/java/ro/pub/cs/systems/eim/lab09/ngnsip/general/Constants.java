...
public interface Constants {
    ...
    final public static String USERNAME = "emiliavoicu";
    final public static String IDENTITY_IMPI = "unipub";
    final public static String IDENTITY_PASSWORD = "DqHKGfBmqYJN6hGb";
    final public static String DOMAIN = "unipub.onsip.com";
